...
#include "skyline/net/Connector.h"
...
void Connector::handleWrite()
{
  ...
  if (state_ == kConnecting)
  {
    // connection has created, do not need to watch writeable event of channel
    // so reset this channel
    int sockfd = removeAndResetChannel();
    // writeable socket is not mean there has no error, double check
...
void Connector::retry(int sockfd)
{
  ...
  if (connect_)
  {
    ...
    // every time of retrying, the delay ms time will double
