#ifndef SKYLINE_NET_TIMERQUEUE_H
#define SKYLINE_NET_TIMERQUEUE_H
...
class TimerQueue : noncopyable
{
 ...
 private:
  ...
  // This requires heterogeneous comparison looup (N3456) form C++14
...
#endif // SKYLINE_NET_TIMERQUEUE_H
